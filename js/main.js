...
document.addEventListener('DOMContentLoaded', function () {
   ...
   // Run the preloader logic only if it exists in the DOM
   if (preloader) {
   ...
   // Optional: Smooth scroll after main content is shown
...
$(document).ready(function () {
    ...
    $('.menu a[href^="#"], .offcanvas a[href^="#"], .footer-link a[href^="#"]').on('click', function (e) {
        e.preventDefault();
...
$(document).ready(function () {
  ...
  if ($(window).width() < 992) {
    $(document).on('click', '.menu ul li', function (event) {
      if (!$(event.target).hasClass('click-btn')) {
        $('.menu ul li').removeClass('active');
        $(this).addClass('active');
      }
    });
...
$(document).ready(function () {
   ...
   $(".slider").on("afterChange", function (event, slick, currentSlide) {
      $(".banner-text").removeClass("animated"); // Remove previous animations
      $(".slick-active .slick-animate").each(function () {
   ...
   $(".slider").trigger("afterChange", [null, null, 0]);
...
$(document).ready(function () {
   $('.service-slider').slick({
      ...
      arrows: true,
      prevArrow: '<span class="prev-slide"><i class="fa-solid fa-angle-left"></i></span>',
      nextArrow: '<span class="next-slide"><i class="fa-solid fa-angle-right"></i></span>',
...
$(document).ready(function () {
   $('.testimonial-inner-slider').slick({
...
const calcScrollValue = () => {
   ...
   if (percentVal === 0) {
      scrollToTop.style.background = '#ebe9e9';
      scrollToTop.style.border = '1px solid var(--white-color)';
   } else {
      scrollToTop.style.background = 'var(--white-color)';
      scrollToTop.style.border = '1px solid transparent';
      scrollToTop.style.backgroundImage = `conic-gradient(var(--primary-color) ${percentVal}%, var(--white-color) ${percentVal}%)`;
      scrollToTop.style.backgroundOrigin = 'border-box';
      scrollToTop.style.backgroundClip = 'padding-box, border-box';
   }
};

// Show/hide and animate scroll-to-top button
